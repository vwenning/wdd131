const hikes = [
  ...
  // Function to display hikes in the HTML
  function displayHikes() {
    ...
    hikes.forEach(hike => {
      ...
      hikeCard.innerHTML = `
        ...
        <p><em>${hike.tags.join(', ')}</em></p>
        <p><strong>Directions:</strong> ${hike.directions}</p>
      `;
  ...
  // Function to display fruits list in the HTML
  function displayFruits() {
    const fruitsList = document.getElementById('fruits-list');
    
    // Sorting the simpleList
    const sortedList = simpleList.sort();
    
    sortedList.forEach(fruit => {
  ...
  // Call functions to display hikes and fruits
  displayHikes();
  displayFruits();
